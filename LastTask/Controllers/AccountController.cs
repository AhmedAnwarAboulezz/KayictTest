...
namespace LastTask.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model, string UserNames, string Name, string Gender, string academiclevel)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var userid = user.Id;
                    AspNetUser userss = db.AspNetUsers.Find(userid);
                    userss.PhoneNumber = model.PhoneNumber;
